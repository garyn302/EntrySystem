...
urlpatterns = [
    ...
    url(r'^EntryControl/Domain/$', entrycontrol_views.getdomain, name= 'getdomain'),
    url(r'^EntryControl/Domain/(?P<DomainName>(\w.+))/$', entrycontrol_views.domain_reader, name='domain_reader'),
